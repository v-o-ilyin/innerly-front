...
export function Hero() {
  return (
    <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-brand-50 via-amber-50/40 to-white">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-xl text-stone-500 mb-8 max-w-xl font-medium">
              Разгрузи голову и разберись с эмоциями за 5 минут в день
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <Button size="lg" asChild>
                <a href="https://t.me/innerly_ai_bot" target="_blank" rel="noreferrer" onClick={() => ym(108444641, 'reachGoal', 'heroButton')}>
                  Начать в Telegram
          ...
          <div className="flex-shrink-0 relative">
            <div className="w-64 h-[540px] bg-gradient-to-b from-brand-700 to-brand-900 rounded-[44px] shadow-2xl shadow-brand-300/60 p-[10px] relative">
              <div className="w-full h-full bg-white rounded-[36px] overflow-hidden flex flex-col">

                {/* iOS status bar */}
                <div className="bg-brand-500 grid grid-cols-3 items-center px-4 pt-2 pb-1">
                ...
                {/* Chat header */}
                <div className="bg-brand-500 px-4 pt-1 pb-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-brand-100 text-[10px]">бот онлайн</p>
                  </div>
                </div>

                {/* Chat messages */}
                <div className="flex-1 bg-[#f5f0eb] p-3 flex flex-col gap-2 overflow-hidden">
                  ...
                  <div className="ml-auto bg-brand-500 rounded-2xl rounded-tr-sm px-3 py-2 max-w-[70%]">
                  ...
                  <div className="ml-auto bg-brand-500 rounded-2xl rounded-tr-sm px-3 py-2 max-w-[72%]">
                    <p className="text-[11px] text-white">Поспорила с подругой</p>
                  </div>
                </div>

                {/* Input bar */}
                <div className="bg-white px-3 py-2 flex items-center gap-2 border-t border-stone-100">
                  <div className="flex-1 bg-stone-100 rounded-full px-3 py-1.5">
                    <p className="text-[11px] text-stone-400">Написать...</p>
                  </div>
            ...
            <div className="absolute -right-4 top-20 bg-white rounded-2xl shadow-lg px-3 py-2 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-stone-500">за эту неделю</p>
              </div>
            </div>
            <div className="absolute -left-4 bottom-28 bg-white rounded-2xl shadow-lg px-3 py-2 flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-stone-500">настроение ↑</p>
              </div>
            </div>
          </div>
        </div>
